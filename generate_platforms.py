        ...
        "tiers": [
            {
                ...
                "period": "forever",
                "cta_label": "Start Free",
                "cta_href": "../../AlohaOneApp/index.html?platform=document&intent=register&tier=free",
                "features": [
                    "5 GB total storage",
                    "Up to 3 users",
...
"case": {
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Built for regulated work, priced for any team size",
        "sub": "Start free with 100 cases and upgrade when you outgrow it. No credit card required to start.",
        "tiers": [
            {
                "name": "Free",
                "price": "$0",
                "period": "forever",
                "cta_label": "Start Free",
                "cta_href": "../../AlohaOneApp/index.html?platform=case&intent=register&tier=free",
                "features": [
                    "100 cases",
                    "Up to 3 users",
