...
"commerce": {
    ...
    "integrations": [
        ...
        {"slug": "cms", "name": "AlohaCMS", "note": "Enable a marketing site, blog, and content pages on any storefront"},
        ...
        {"slug": "assistant", "name": "AlohaAssistant", "note": "Customers can call to check order status and place orders by voice"},
...
"document": {
    ...
    "integrations": [
        {"slug": "drive", "name": "AlohaDrive", "note": "Promote any Drive file to a managed document with OCR and retention"},
        ...
        {"slug": "knowledge", "name": "AlohaKnowledge", "note": "Knowledge articles cite and embed formal documents"},
        {"slug": "configurator", "name": "AlohaConfigurator", "note": "Spec sheets and technical drawings attached to configurations"},
        ...
        {"slug": "deliver", "name": "AlohaDeliver", "note": "Photo and video proof of delivery archived as documents"},
        {"slug": "agent", "name": "AlohaAgent", "note": "Agents can search and summarize your documents"},
    ],
    "pricing": {
        "label": "Pricing",
        "heading": "Document management that scales with your team",
        "sub": "Start free with 5 GB and upgrade when your repository outgrows it. No credit card required to start.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                "period": "free forever",
                "cta_label": "Start Free",
                "cta_href": "../../AlohaOneApp/index.html?platform=document&intent=register&tier=starter",
                "features": [
                    "5 GB total storage",
                    "Up to 3 users",
                    "OCR on every uploaded PDF and image",
                    "Full-text search across content and metadata",
                    "Custom metadata per document type",
            ...
            },
            {
                ...
                "featured": True,
                "cta_label": "Start Pro",
                "cta_href": "../../AlohaOneApp/index.html?platform=document&intent=register&tier=pro",
                "features": [
                    "Everything in Starter, plus:",
                    "1 TB storage pooled across the team",
                    "Unlimited users",
                    "Audio and video transcription",
                    "Microsoft Entra / Azure AD SSO",
                    "Compliance-ready audit exports",
...
"case": {
    ...
    "integrations": [
        ...
        {"slug": "drive", "name": "AlohaDrive", "note": "Browse Drive files when attaching evidence to a case"},
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Built for regulated and legal work, priced honestly",
        "sub": "Start free with 100 cases and 3 users. Upgrade to a per-attorney plan when you're ready for serious case load. No credit card required to start.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                "period": "free forever",
                "cta_label": "Start Free",
                "cta_href": "../../AlohaOneApp/index.html?platform=case&intent=register&tier=starter",
                "features": [
                    "100 cases",
                    "Up to 3 users",
                    "Configurable case types and workflows",
                    "Documents in context with full-text search",
                    "Append-only case timeline and comments",
                    "CSV export of any case list",
                    "Email support",
                ],
            },
            {
                ...
                "featured": True,
                "cta_label": "Start Pro",
                "cta_href": "../../AlohaOneApp/index.html?platform=case&intent=register&tier=pro",
                "features": [
                    "Everything in Starter, plus:",
                    "Unlimited cases",
                    "Time tracking and billable hours",
                    "Document automation and templates",
                    "Custom views and column selection",
                    "Microsoft Entra / Azure AD SSO",
                    "Priority email support",
                ],
            },
            {
                ...
                "features": [
                    ...
                    "Use our encryption keys or bring your own (BYOK)",
                    "Multi-office and team permissions",
...
"configurator": {
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Configurator pricing you don't have to ask for",
        "sub": "Already an AlohaCommerce customer? AlohaConfigurator is included free — toggle it on in your dashboard. Buying standalone? Try the full engine free for 30 days, then pick a plan.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                "period": "30-day free trial",
                "cta_label": "Start Trial",
                "cta_href": "../../AlohaOneApp/index.html?platform=configurator&intent=register&tier=starter",
                "features": [
                    "Try the full 3D engine for 30 days",
                    "3 configurators",
                    "25,000 trial views",
                    "3D viewer + AR + material/color config",
                    "Embed on any site",
                    "After 30 days: choose Pro to continue",
                ],
            },
            {
                "name": "Pro",
                ...
                "featured": True,
                "cta_label": "Start Pro",
                "cta_href": "../../AlohaOneApp/index.html?platform=configurator&intent=register&tier=pro",
                "features": [
                    "15 configurators",
...
"backup": {
    ...
    "integrations": [
        {"slug": "drive", "name": "AlohaDrive", "note": "Backup protects entire devices on a schedule; Drive holds the active files you work with day-to-day"},
        ...
        "tiers": [
            {
                ...
                "period": "free forever",
                "cta_label": "Start Free",
                "cta_href": "../../AlohaOneApp/index.html?platform=backup&intent=register&tier=starter",
                "features": [
                    "1 device",
                    "5 GB total storage",
            ...
            },
            {
                ...
                "price": "$19.95",
                "period": "per month",
                "cta_label": "Start Enterprise",
                "cta_href": "../../AlohaOneApp/index.html?platform=backup&intent=register&tier=enterprise",
                "features": [
                    "10 devices",
                    "2 TB total storage",
                    "500 GB per device",
...
"drive": {
    ...
    "integrations": [
        ...
        {"slug": "cms", "name": "AlohaCMS", "note": "Drive's media library powers AlohaCMS — edit assets in Drive, see them on your site"},
...
"cms": {
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Per-site pricing that doesn't punish your team",
        "sub": "Free to start with an aloha.one subdomain. Bring your own domain on Pro. Multi-site discounts on Enterprise.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                ...
                "features": [
                    ...
                    "Blog and 3 forms",
                    "AlohaDrive media library (2 GB shared)",
                    "1 editor",
                ],
            },
            {
                ...
                "features": [
                    ...
                    "5,000 CMS items",
                    "Full SEO toolkit",
                    "Unlimited forms and lead capture",
                    "AlohaCommerce storefront toggle",
                    "5 editors",
                    "50 GB AlohaDrive media",
                ],
            },
            {
                "name": "Enterprise",
...
"crm": {
    ...
    "integrations": [
        ...
        {"slug": "cms", "name": "AlohaCMS", "note": "Form submissions from CMS pages flow into contacts and leads"},
        ...
        {"slug": "drive", "name": "AlohaDrive", "note": "Attach Drive files to contact and company records"},
        {"slug": "case", "name": "AlohaCase", "note": "Link cases to parties and contacts"},
        {"slug": "affiliate", "name": "AlohaAffiliate", "note": "Affiliate partners are contacts with a partner role"},
        {"slug": "assistant", "name": "AlohaAssistant", "note": "Caller ID lookup and contact auto-update from voice calls"},
        {"slug": "message", "name": "AlohaMessage", "note": "Every inbox message attached to a contact record"},
        {"slug": "social", "name": "AlohaSocial", "note": "Social engagement tracked on contact timelines"},
        {"slug": "deliver", "name": "AlohaDeliver", "note": "Customer delivery history on every contact timeline"},
        {"slug": "data", "name": "AlohaData", "note": "Customer and pipeline analytics flow to the warehouse"},
        {"slug": "training", "name": "AlohaTraining", "note": "Track who's been trained on what across the team"},
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "CRM that grows with your team",
        "sub": "Already an AlohaCommerce customer? AlohaCRM is included free — toggle it on in your dashboard. Buying standalone? Choose a plan below.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                "period": "free forever",
                "cta_label": "Start Free",
                "cta_href": "../../AlohaOneApp/index.html?platform=crm&intent=register&tier=starter",
                "features": [
                    "3 users",
                    "1,000 contacts",
                    "1 pipeline",
            ...
            },
            {
                ...
                "featured": True,
                "cta_label": "Start Pro",
                "cta_href": "../../AlohaOneApp/index.html?platform=crm&intent=register&tier=pro",
                "features": [
            ...
            },
            {
                ...
                "features": [
                    ...
                    "Call recording (with AlohaAssistant)",
                    "Use our encryption keys or bring your own (BYOK)",
                    "SAML SSO and SCIM provisioning",
...
"affiliate": {
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Affiliate management without the seat tax",
        "sub": "Already an AlohaCommerce customer? AlohaAffiliate is included free — toggle it on in your dashboard. Buying standalone? Choose a plan below.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                "period": "free forever",
                "cta_label": "Start Free",
                "cta_href": "../../AlohaOneApp/index.html?platform=affiliate&intent=register&tier=starter",
                "features": [
                    "1 campaign",
                    "25 affiliates",
                    "$1,000 tracked revenue / month",
                    "Tracking links and coupon codes",
                    "Manual payouts",
            ...
            },
            {
                ...
                "featured": True,
                "cta_label": "Start Pro",
                "cta_href": "../../AlohaOneApp/index.html?platform=affiliate&intent=register&tier=pro",
                "features": [
                    "Unlimited campaigns and affiliates",
                    "$50,000 tracked revenue / month",
...
"marketing": {
    ...
    "integrations": [
        ...
        {"slug": "cms", "name": "AlohaCMS", "note": "Landing pages and the marketing site live in CMS"},
        ...
        {"slug": "survey", "name": "AlohaSurvey", "note": "Segment audiences by survey response"},
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Marketing automation that scales with your audience",
        "sub": "Free for your first 500 contacts. Pro adds multi-channel orchestration. Enterprise unlocks dedicated infrastructure.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
            ...
            },
            {
                ...
                "features": [
                    ...
                    "AlohaCRM segment audiences",
                    "Live attribution and analytics",
                ],
            },
            {
                "name": "Enterprise",
                ...
                "features": [
                    "Everything in Pro, plus:",
                    "50,000+ contacts",
                    "Dedicated sending IPs (via AlohaEmail)",
                    "Use our encryption keys or bring your own (BYOK)",
                    "SAML SSO",
...
"email": {
    ...
    "integrations": [
        ...
        {"slug": "cms", "name": "AlohaCMS", "note": "CMS form submissions trigger email notifications"},
        ...
        {"slug": "survey", "name": "AlohaSurvey", "note": "Embed surveys in transactional and drip emails"},
        {"slug": "message", "name": "AlohaMessage", "note": "Outbound email channel for the unified Message inbox"},
        {"slug": "training", "name": "AlohaTraining", "note": "Course reminders and completion notices"},
        {"slug": "deliver", "name": "AlohaDeliver", "note": "Delivery notification emails for every shipment"},
    ],
    "pricing": {
        "label": "Pricing",
        "heading": "Transactional and drip email priced for builders",
        "sub": "Volume-based pricing like the rest of the market. Free for small projects, scales as you grow.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
            ...
            },
            {
                ...
                "features": [
                    ...
                    "White-glove deliverability consulting",
                    "99.95% uptime SLA",
                    "Dedicated customer success manager",
                ],
            },
...
"survey": {
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Surveys without the response cap surprise",
        "sub": "Unlimited forms on every plan. We charge for the responses, not the forms.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
            ...
            },
            {
                ...
                "features": [
                    ...
                    "Custom branding (no AlohaOne logo)",
                    "AlohaCRM contact sync",
...
"support": {
    ...
    "integrations": [
        ...
        {"slug": "drive", "name": "AlohaDrive", "note": "Attach Drive files to tickets without re-uploading"},
        {"slug": "knowledge", "name": "AlohaKnowledge", "note": "Suggested articles and deflection"},
        {"slug": "document", "name": "AlohaDocument", "note": "Link reference docs to tickets for context"},
        {"slug": "case", "name": "AlohaCase", "note": "Escalate complex tickets into formal cases"},
        {"slug": "email", "name": "AlohaEmail", "note": "Outbound ticket replies via the deliverability pipeline"},
        {"slug": "survey", "name": "AlohaSurvey", "note": "Auto-send CSAT surveys after ticket resolution"},
        {"slug": "training", "name": "AlohaTraining", "note": "Surface knowledge gaps from ticket patterns"},
        {"slug": "project", "name": "AlohaProject", "note": "Escalate engineering issues from tickets to projects"},
        {"slug": "social", "name": "AlohaSocial", "note": "Triage social DMs and comments as tickets"},
        {"slug": "agent", "name": "AlohaAgent", "note": "AI agents handle tier-1 tickets"},
    ],
    "pricing": {
        "label": "Pricing",
        "heading": "Helpdesk that doesn't punish growing teams",
        "sub": "Sits between Freshdesk and Zendesk on price, with ecosystem integration nobody else can match.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
...
"knowledge": {
    ...
    "integrations": [
        ...
        {"slug": "drive", "name": "AlohaDrive", "note": "Embed Drive media directly in knowledge articles"},
        {"slug": "project", "name": "AlohaProject", "note": "Link articles to project tasks and decisions"},
        {"slug": "commerce", "name": "AlohaCommerce", "note": "Self-serve articles and FAQs for your storefront"},
        {"slug": "agent", "name": "AlohaAgent", "note": "AI agents answer from your knowledge"},
    ],
    "pricing": {
        "label": "Pricing",
        "heading": "Knowledge base pricing that doesn't penalize sharing",
        "sub": "Free for small teams. Pro adds unlimited everything. Enterprise adds the controls procurement asks for.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
            ...
            },
            {
                ...
                "features": [
                    ...
                    "Hierarchies and folder permissions",
                    "AlohaDrive attachment library",
                    "Cross-product embeds (AlohaProject, AlohaCMS)",
...
"training": {
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Training that fits your team — solo creator or 10,000-learner enterprise",
        "sub": "Flat-priced Pro for creators and SMB. Per-active-learner Enterprise for corporate L&D.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                ...
                "features": [
                    ...
                    "3 courses",
                    "1 admin",
                    "Lessons, quizzes, completion tracking",
                    "Basic certificates",
                    "AlohaOne branding",
                ],
            },
            {
                ...
                "features": [
                    ...
                    "Unlimited courses",
                    "5 admins",
                    "Drip content and assignments",
                    "Custom certificates",
                    "Branded learner portal",
                    "AlohaDrive asset embeds",
                    "0% transaction fees",
                    "SCORM import",
                ],
            },
...
"project": {
    ...
    "integrations": [
        ...
        {"slug": "drive", "name": "AlohaDrive", "note": "Reference Drive files as task attachments and design assets"},
        ...
        {"slug": "configurator", "name": "AlohaConfigurator", "note": "Custom configurations become production tasks automatically"},
        {"slug": "inventory", "name": "AlohaInventory", "note": "Track assembly and rework against component stock"},
        {"slug": "agent", "name": "AlohaAgent", "note": "AI agents triage and draft tickets"},
    ],
    "pricing": {
        "label": "Pricing",
        "heading": "Project management priced like Linear, integrated like nothing else",
        "sub": "A direct Jira and Linear alternative — with native AlohaOne identity, embeds, and BYOK on Enterprise.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                ...
                "features": [
                    ...
                    "500 issues",
                    "3 projects",
                    "Boards, sprints, basic roadmaps",
                    "Comments and activity feed",
                    "AlohaKnowledge embeds",
                ],
            },
            {
                "name": "Pro",
            ...
            },
            {
                ...
                "features": [
                    ...
                    "SAML SSO and SCIM provisioning",
                    "Audit logs",
                    "Advanced roadmaps and portfolios",
                    "Sandbox environment",
                    "Volume discounts at 100+ seats",
                ],
            },
...
"inventory": {
    ...
    "integrations": [
        ...
        {"slug": "configurator", "name": "AlohaConfigurator", "note": "Made-to-order configurations resolve against component stock in real time"},
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Inventory built for makers and configurable products",
        "sub": "Already an AlohaCommerce customer? AlohaInventory is included free — toggle it on in your dashboard. Buying standalone? Choose a plan below.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                "period": "free forever",
                "cta_label": "Start Free",
                "cta_href": "../../AlohaOneApp/index.html?platform=inventory&intent=register&tier=starter",
                "features": [
                    "1 user",
                    "1 location",
                    "50 SKUs",
            ...
            },
            {
                ...
                "featured": True,
                "cta_label": "Start Pro",
                "cta_href": "../../AlohaOneApp/index.html?platform=inventory&intent=register&tier=pro",
                "features": [
                    "10 users",
                    "3 locations",
                    "Unlimited SKUs",
                    ...
                    "AlohaConfigurator made-to-order link",
                    "Public REST API",
                ],
            },
            {
...
"deliver": {
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Per-driver pricing — no flat-tier traps",
        "sub": "Free for solo drivers and freelancers. Pro for fleets that need real optimization. Photo and video proof of delivery on every plan.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
            ...
            },
            {
                ...
                "features": [
                    ...
                    "5 dispatchers",
                    "Photo and video proof of delivery",
                    "Route optimization",
                    "Auto-dispatch",
                    "Dynamic ETA",
                    "Public REST API",
            ...
            },
            {
                ...
                "features": [
                    ...
                    "Multi-depot and multi-brand",
                    "Use our encryption keys or bring your own (BYOK)",
                    "SAML SSO",
                    "Custom workflows",
                    "Dedicated customer success manager",
                    "99.9% uptime SLA",
                    "Contact sales for fleets above 50 drivers",
                ],
            },
        ],
    },
...
"social": {
    ...
    "integrations": [
        ...
        {"slug": "message", "name": "AlohaMessage", "note": "Social DMs and comments captured in the unified Message inbox"},
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Social management without the per-channel tax",
        "sub": "Flat-priced Pro — not per-channel like Buffer. We don't punish you for using more networks.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
            ...
            },
            {
                ...
                "features": [
                    ...
                    "All networks (FB, IG, X, LinkedIn, TikTok, YouTube, Pinterest, Threads, Bluesky)",
...
"assistant": {
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Voice AI you can actually budget for",
        "sub": "Hybrid platform fee + per-minute, like Bland AI. Starter passes through our cost ($0.13/min) so you can experiment risk-free.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0/mo + $0.13/min",
                ...
                "features": [
                    ...
                    "$0 monthly base fee",
                    "Per-minute charged at our cost ($0.13/min)",
                    "1 voice, 1 phone number",
                    "5 concurrent calls",
                    "AlohaCRM caller lookup",
                    "Basic call routing",
                ],
            },
            {
                ...
                "features": [
                    ...
                    "Appointment booking",
                    "Call transcripts to AlohaSupport / AlohaCRM",
...
"message": {
    ...
    "integrations": [
        ...
        {"slug": "drive", "name": "AlohaDrive", "note": "Send Drive files in messages without re-uploading"},
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Unified inbox priced for the way teams actually work",
        "sub": "All channels on every plan. We don't gate WhatsApp or SMS behind a higher tier — that's the point of unified.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
...
"data": {
    ...
    "integrations": [
        ...
        {"slug": "inventory", "name": "AlohaInventory", "note": "Stock levels, turn rates, and forecasting analytics"},
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Warehouse pricing without the credits-and-slots PhD",
        "sub": "Flat-priced tiers with metered overage. The differentiator: zero-config ELT from every other AlohaOne platform — no engineering required.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                ...
                "features": [
                    ...
                    "Zero-config ELT from every AlohaOne platform",
                    "SQL workbench",
                    "3 BI connectors",
                    "Row-level security",
                ],
            },
            {
                ...
                "features": [
                    ...
                    "200 compute-hours / month included",
                    "Unlimited BI connectors",
                    "Row-level security and column masking",
                    "Use our encryption keys or bring your own (BYOK)",
                    "Overage: $25 per TB / month storage, $3.00 per compute-hour",
                ],
            },
            {
                "name": "Enterprise",
                ...
                "features": [
                    ...
                    "Multi-workspace",
                    "Query acceleration and materialized views",
                    "Dedicated compute and VPC peering",
                    "HIPAA BAA",
                    "HSM-backed BYOK",
                    "99.95% uptime SLA",
                    "25% annual prepay discount",
                    "Overage: $22 per TB / month storage, $2.25 per compute-hour",
                    "Contact for capacity above 5 TB",
                ],
            },
        ],
    },
...
"search": {
    ...
    "integrations": [
        ...
        {"slug": "cms", "name": "AlohaCMS", "note": "Search across CMS pages and blog content"},
    ...
    "pricing": {
        "label": "Pricing",
        "heading": "Search is infrastructure, not a separate product",
        "sub": "AlohaSearch is included free with every AlohaOne platform that needs it. The real differentiator — federated cross-platform search — only works when it's bundled, so we don't sell it standalone.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                "period": "included with every AlohaOne platform",
                "cta_label": "See All Platforms",
                "cta_href": "../index.html#platforms",
                "features": [
                    "Full-text search across your content",
                    "Semantic and vector search (where supported)",
                    "Federated search across AlohaDocument, AlohaCase, AlohaDrive, AlohaKnowledge, AlohaCRM, and AlohaData",
                    "Snippet highlighting and relevance ranking",
                    "Faceted filters and saved searches",
                    "Included in every paid AlohaOne plan that needs it",
                    "No standalone purchase required or available",
                ],
            },
        ],
    },
...
"agent": {
    ...
    "integrations": [
        ...
        {"slug": "commerce", "name": "AlohaCommerce", "note": "Agents handle product Q&A and order status"},
        {"slug": "case", "name": "AlohaCase", "note": "Agents summarize cases and surface relevant precedents"},
        {"slug": "backup", "name": "AlohaBackup", "note": "Agents can search your backed-up file history"},
        {"slug": "marketing", "name": "AlohaMarketing", "note": "Agents write and optimize campaigns"},
        {"slug": "inventory", "name": "AlohaInventory", "note": "Agents forecast demand and flag stock anomalies"},
        {"slug": "deliver", "name": "AlohaDeliver", "note": "Agents resolve delivery disputes with photo and video evidence"},
        {"slug": "social", "name": "AlohaSocial", "note": "Agents write, schedule, and respond to social posts"},
        {"slug": "assistant", "name": "AlohaAssistant", "note": "Agents power voice interactions through AlohaAssistant"},
        {"slug": "message", "name": "AlohaMessage", "note": "Agents draft replies in the unified inbox"},
        {"slug": "project", "name": "AlohaProject", "note": "Agents triage tickets and draft project plans"},
    ],
    "pricing": {
        "label": "Pricing",
        "heading": "Hybrid pricing built for agent unit economics",
        "sub": "Seat fee covers our orchestration. Run quota protects against runaway loops. Model tokens billed at pass-through plus a small markup. Reserved credits available at any tier.",
        "tiers": [
            {
                "name": "Starter",
                "price": "$0",
                ...
                "features": [
                    ...
                    "Haiku-class models only",
                    "Up to 5 tool calls per run",
                    "Runs against AlohaOne platforms you already subscribe to",
                ],
            },
            {
                "name": "Pro",
                ...
                "features": [
                    "Unlimited agents",
                    "2,500 runs / seat / month included",
                    "All model classes (Haiku, Sonnet, Opus pass-through)",
                    "Unlimited tool calls per run",
                    "Observability and tracing",
                    "Agent versioning and shared library",
                    "Overage: $0.04 per run beyond included",
                    "Model tokens billed at pass-through + 20% markup",
                ],
            },
            {
                "name": "Enterprise",
                ...
                "features": [
                    ...
                    "Scheduled and cross-workspace agents",
                    "A/B testing and custom MCP tools",
                    "Use our encryption keys or bring your own (BYOK)",
                    "SAML SSO and audit logs",
                    "Overage: $0.03 per run, model token markup drops to 15%",
                    "Reserved credit prepurchase: $10K / $50K / $250K blocks for 10% / 15% / 20% discount",
                    "Dedicated tenancy and SLAs available",
                ],
            },
        ],
    },
